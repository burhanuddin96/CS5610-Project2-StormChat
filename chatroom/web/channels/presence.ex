defmodule Faster.Presence do
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Faster.MyChannel do
        use FasterWeb, :channel
        alias Faster.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :faster,
                        pubsub_server: Faster.PubSub
end
